...
class GenConfig:
    ...
    sizes: Dict[RoomType, Tuple[Size, Size]] = field(
        default_factory=lambda: {
            RoomType.SPAWN:     ((24, 30), (22, 26)),
            RoomType.NORMAL:    ((36, 48), (26, 34)),
            RoomType.HARD:      ((48, 60), (36, 46)),
            RoomType.CAFETERIA: ((60, 72), (32, 40)),
            RoomType.TOILET:    ((24, 30), (34, 44)),
            RoomType.CHEST:     ((24, 30), (22, 28)),
            RoomType.EVENT:     ((44, 54), (28, 36)),
            RoomType.BOSS:      ((64, 76), (52, 62)),
            RoomType.STAIRS:    ((26, 32), (22, 28)),
        }
    )
    ...
    corridor_length: Tuple[int, int] = (8, 20)
    #: 8 тайлов — это 3.3 м, ширина настоящего школьного коридора.
    ...
    loop_corridor_length: Tuple[int, int] = (6, 40)
